...
@section('title', 'Edit Member - JCI Carthage')
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold jci-primary-text">Edit Member</h1>
    </div>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="role" id="role" required
                    ...
                    <option value="vice-president" {{ old('role', $user->role) == 'vice-president' ? 'selected' : '' }}>Vice President</option>

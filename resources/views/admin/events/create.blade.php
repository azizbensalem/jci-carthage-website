...
@section('title', 'Créer un événement - JCI Carthage')
...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold jci-primary-text">Créer un événement</h1>
    </div>
        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="type" id="type" required
                    ...
                    <option value="{{ $key }}" {{ old('type', 'project') == $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @error('type')

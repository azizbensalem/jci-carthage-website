...
@section('title', 'Créer un élément de carrousel - JCI Carthage')
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold jci-primary-text">Créer un élément de carrousel</h1>
    </div>
    ...
    <div class="jci-card p-6">
        <form action="{{ route('admin.carousels.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="button_text" id="button_text" value="{{ old('button_text') }}" placeholder="Découvrir plus"
